# HANDOFF v5 — Projeto Dr. Julia Resende
**Data:** 13/03/2026 — sessão tarde
**De:** Atlas (@analyst)
**Para:** Próxima sessão
**Supersede:** HANDOFF-DR-JULIA-RESENDE-v4.md (13/03/2026 manhã) — este documento é o definitivo
...
ONDE PAROU:
  ...
  Passo 4 — Lógica de alternância: ✅ APROVADO (13/03/2026 tarde)
  Passo 5 — Logo: ❌ Não iniciado → @aaron-draplin
  Passo 6 — DS final compilado: ✅ CONCLUÍDO → C:\Users\felip\Documents\DR-JULIA-RESENDE-DS.yaml
  Passo 7 — Squad automatizado: ❌ PRÓXIMO → squad-creator-pro
...
## 6. LÓGICA DE ALTERNÂNCIA E CALENDÁRIO ✅ APROVADO (Passo 4 — 13/03/2026)

### Camada 1 — Alternância de cor
```
Post 1 → Verde  #03bb85
Post 2 → Branco #FFFFFF
Post 3 → Verde
Post 4 → Branco
... (sempre alternado, sem exceção)
```

### Camada 2 — Frequência de postagem
```
FEED (posts + carrosséis): 4x por semana
  Dias: Segunda, Quarta, Sexta, Sábado

STORIES: diário (7x por semana)
```

### Camada 3 — Ciclo de conteúdo (4 pilares)
```
Pilar E  — Educativo    → Carrossel Educativo (5 slides)
Pilar EM — Emocional    → Post Único (frase de impacto)
Pilar PS — Prova Social → Carrossel Prova Social (4 slides)
Pilar C  — CTA          → Post Único (gancho forte + link bio)

Ciclo: E → EM → PS → C → E → EM → PS → C...
```

### Semana-padrão completa
```
SEGUNDA  → Verde  → Carrossel Educativo (E)
TERÇA    → Story Frase de Impacto (reforça segunda)
QUARTA   → Branco → Post Único Emocional (EM)
QUINTA   → Story Sticker Interativo (enquete/caixa de perguntas)
SEXTA    → Verde  → Carrossel Prova Social (PS)
SÁBADO   → Branco → Post Único CTA (C)
DOMINGO  → Story Frase de Impacto (aquece a segunda)
```

### Proporção mensal (~4 semanas)
```
Carrossel Educativo:  8 posts  (40%)
Post Único:           8 posts  (40%)  → 4 emocionais + 4 CTA
Carrossel Prova Soc:  4 posts  (20%)

Stories:             28 stories
  └ ~14 Frase de Impacto
  └ ~14 Sticker Interativo
```

---

## 7. PERSONA DE COPY — TOM DE VOZ ✅ DEFINIDO
...
## 9. OBJETIVO FINAL — AUTOMAÇÃO COMPLETA
...
## 10. PRÓXIMOS PASSOS (ordem exata)

### ❌ Passo 5 — Logo (PRÓXIMO)
Aaron Draplin (`@Design:agents:aaron-draplin`) gera o prompt.
...
Contém: Design System completo, persona, formatos, alternância, prompts, logo e regras.

### ❌ Passo 7 — Squad de conteúdo automatizado (PRÓXIMO)
...
```
HANDOFFS:
├── C:\Users\felip\Documents\HANDOFF-DR-JULIA-RESENDE-v5.md ← ESTE (definitivo)
├── C:\Users\felip\Documents\HANDOFF-DR-JULIA-RESENDE-v4.md (13/03/2026 manhã)
├── C:\Users\felip\Documents\HANDOFF-DR-JULIA-RESENDE-v3.md (12/03/2026 tarde/noite)
...
## 12. INFORMAÇÕES QUE NÃO PODEM SE PERDER
...
Design System v3 completo. Passos 1, 2, 3 e 4 aprovados.
Desalinhamento do ebook resolvido — patrão aprovou a ponte.
Próximo passo: Passo 5 — Logo (@aaron-draplin).
O handoff completo está em: C:\Users\felip\Documents\HANDOFF-DR-JULIA-RESENDE-v5.md
...
*13/03/2026 — sessão tarde*
*Supersede: HANDOFF-DR-JULIA-RESENDE-v4.md*
