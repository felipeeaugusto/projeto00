...
- [14/08/2026] dev — checagem via Alterar de MLBs revelados dentro de um "ID Family" às vezes falha "não encontrou botão/item" sem o marcador de "ML inativou" que explicaria isso -- suspeita não confirmada: índice posicional do botão pode não corresponder à ordem real depois que grupos ID Family são expandidos (caso real: SKU `PROSB-3000`, MLBs `#4935589470`/`#5267746586`) -- arquivo: `packages/karzen/.aiox-runtime/pipeline-pausados-campanha-completo.js`
- [14/08/2026] dev — casamento de preço (via Alterar) pra MLB revelado dentro de um "ID Family" às vezes não bate com nenhum preço próprio do MLB, mesmo com Concorrência confirmada -- preço capturado pode pertencer a um MLB diferente (caso real: SKU `PROSB-3000`, MLB `#5267746592`, preço capturado "239,90" não bate com precoBase "279" nem precoPromo "210,48") -- arquivo: `packages/karzen/.aiox-runtime/pipeline-pausados-campanha-completo.js`
