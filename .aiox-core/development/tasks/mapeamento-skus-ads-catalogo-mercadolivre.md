...
**Os 3 formatos confirmados como catálogo de verdade (todos COM "COMPETINDO" visível, com prints de referência em `C:\Users\Felipe Augusto\Pictures\Processo Oficial\mlb1.png` a `mlb4.png`):**
...
**⚠️ Regra obrigatória, sem exceção — "algo fora do mapeado" (24/08/2026):** se a seção "Concorrência no Mercado Livre" existir, o badge "COMPETINDO" estiver presente, mas o conteúdo não bater com nenhum dos 3 formatos acima — **não classificar como catálogo nem como não-catálogo**. Registrar como indeterminado/pendente e reportar ao Felipe antes de qualquer decisão. Nunca presumir com base em "parece parecido" — essa foi exatamente a falha que gerou a correção de 16-18/08, que ficou errada por 8 dias sem ninguém perceber.
