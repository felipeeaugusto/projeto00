...
1. Pra cada MLB candidato daquela condição (Clássico ou Premium), na aba Anúncios já aberta: clicar nos **3 pontinhos ("Ações secundárias")** da linha específica daquele MLB → **"Abrir link em uma nova guia"** no item **"Alterar"** do menu — **sempre em nova guia, nunca clicar direto** (clicar direto navega a própria aba de Anúncios pra longe, perdendo a listagem/busca do SKU e obrigando a rebuscar do zero pra checar o próximo MLB). A aba de Anúncios com a busca do SKU fica **intacta e aberta** o tempo todo; só a aba "Alterar" abre e fecha, uma de cada vez, uma pra cada MLB candidato.
