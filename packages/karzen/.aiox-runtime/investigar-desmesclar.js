...
(async () => {
  ...
  try {
    ...
    const itens = await page.locator('.goog-menuitem').allTextContents();
    console.log('Itens do menu Formatar:', JSON.stringify(itens, null, 2));

    // fechar o menu sem clicar em nada
