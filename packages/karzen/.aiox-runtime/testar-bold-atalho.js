...
(async () => {
  ...
  try {
    ...
    const boldBtn = page.locator('[aria-label*="Negrito"]').first();
    const boldPressed = await boldBtn.getAttribute('aria-pressed').catch(() => 'erro');
    console.log('Apos Ctrl+B -- Negrito aria-pressed:', boldPressed);
